...
const HomePage = () => {
  ...
  const { allProducts } = useSelector((state) => state?.products)
   const [searchContentOpen, setSearchContentOpen] = useState(false)
  ...
  return (
    <div id="search" onClick={handleSearchClose}> 
      
      <Header activeHeading={1} searchContentOpen={searchContentOpen} setSearchContentOpen={setSearchContentOpen} />
