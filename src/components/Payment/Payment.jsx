...
const PaymentInfo = ({
  ...
  return (
    <div className="w-full 800px:w-[100%%] bg-[#fff] rounded-md py-4 px-2 pb-2">
      {/* select buttons */}
      <div>
  ...
  return (
    <div className="w-full bg-[#fff] rounded-md p-5 pb-8">
      ...
      <div className="flex justify-between items-center mb-2">
        <p className="text-gray-700 font-medium">Price ({orderData?.length} item)</p>
        <p className="text-gray-700 font-medium">₹{orderData.totalOriginalPrice}</p>
      </div>

      <div className="flex justify-between items-center mb-2">
        <p className="text-gray-700 font-medium">Discount</p>
        <p className="text-green-700 font-medium">-₹{orderData.totalDiscountPrice}</p>
      </div>

      <div className="flex justify-between items-center mb-2">
        <p className="text-gray-600 font-medium">Coupons for you</p>
        <p className="text-gray-600 font-medium">-₹{orderData.couponAmount}</p>
      </div>

      <div className="flex justify-between items-center mb-2">
        <p className="text-gray-600 font-medium">Delivery charges</p>
        <h1 className="text-gray-600 font-medium flex items-center gap-2">
          {orderData.deliverCharge === 0 && <span className="line-through">₹{orderData?.length * 40}</span>}
          {orderData.deliverCharge === 0 ? (
            <p className="text-green-700 text-sm">Free delivery</p>
          ) : (
            "₹" + orderData.deliverCharge
          )}
        </h1>
      </div>
      ...
      <div className="flex justify-between items-center mb-4">
        <p className="text-green-700 font-medium">You will save ₹{!orderData.discountPrice ? orderData.totalDiscountPrice : orderData.discountPrice + orderData.totalDiscountPrice} on this order.</p>
      </div>
