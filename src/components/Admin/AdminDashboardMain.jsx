...
import { getAllOrdersOfAdmin, getAllOrdersOfShop } from "../../redux/actions/order";
    ...
    <>
      {adminOrderLoading ? (
        ...
        <div className="w-full p-2 bg-white ">
          ...
          <h2 className="text-[16px] font-Poppins pb-2 text-gray-700 font-light">
          ...
          <div className="w-full block 800px:flex items-center 1000px:justify-around flex-col bg-slate-100 rounded-md">
            <div className="w-full flex items-center justify-between m-1 ">
              <div className=" flex items-center justify-center gap-2 p-2  ">
                ...
                <h2 className="text-[22px] font-Poppins ">
                  Business Analytics
                </h2>
              </div>
            ...
            <div className="w-full  p-2  ">
              <div className="grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4  gap-2 p-2  ">
                <div className=" mb-4 bg-[#e1e1e2]  p-2 min-h-[18vh]  shadow-md hover:shadow-lg border rounded px-2 py-5">
                  ...
                  <h5 className="pt-2 pl-[36px] text-[22px] font-[500] text-center">
                    {sellers && sellers.length}
                  </h5>
                  <Link to="/admin-product" className="text-center b">
                    <h5 className="pt-4 pl-2 text-blue-800 font-bold">
                      View Product
                    </h5>
                  </Link>
                </div>
                ...
                <div className=" mb-4  p-2 min-h-[18vh] bg-[#e1e1e2] shadow-md hover:shadow-lg border rounded px-2 py-5 ">
                  ...
                  <h5 className="pt-2 pl-[36px] text-center text-[22px] font-[500]">
                    {adminOrders && adminOrders.length}
                  </h5>
                  <Link to="/admin-orders">
                    <h5 className="pt-4 pl-2 text-blue-800 font-bold text-center">
                      View Orders
                    </h5>
                  </Link>
                </div>
                ...
                <div className=" mb-4  p-2 min-h-[18vh] bg-[#e1e1e2] shadow-md hover:shadow-lg border rounded px-2 py-5">
                  ...
                  <h5 className="pt-2 pl-[36px] text-[22px] text-center font-[500]">
                    {sellers && sellers.length}
                  </h5>
                  <Link to="/admin-sellers">
                    <h5 className="pt-4 pl-2 text-center text-blue-800 font-bold">
                      View Store
                    </h5>
                  </Link>
                </div>
                ...
                <div className=" mb-4  p-2 min-h-[18vh] bg-[#e1e1e2] shadow-md hover:shadow-lg border rounded px-2 py-5">
                  ...
                  <Link to="/admin-orders">
                    <h5 className="pt-4 pl-2 text-center font-bold text-blue-800">
                      View Customer
                    </h5>
                  </Link>
                </div>
                ...
                <div className="bg-white rounded-md h-[60vh] lex flex-col items-center p-2 ">
                  ...
                  <div className="bg-white w-full p-2 cursor-pointer shadow-md grid lg:grid-cols-2 md:grid-cols-2 400px:grid-cols-2 gap-2  ">
                    <div className="border rounded-md flex flex-col items-center justify-center p-2 h-[15vh] w-full ">
                      ...
                      <p className="text-center text-[12px] py-[2px] px-1 rounded-md border border-blue-400">
                        Order Delivered : 7
                      </p>
                    </div>
