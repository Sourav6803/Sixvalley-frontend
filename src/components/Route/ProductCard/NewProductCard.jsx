...
const NewProductCard = ({ data, isEvent }) => {
  ...
  return (
    <div
      ...
      className="flex items-center justify-between max-w-md h-[140px] bg-white rounded-lg shadow-lg  cursor-pointer transform transition-transform duration-500 hover:scale-105 hover:shadow-2xl"
    >
      ...
      <div className="w-2/3 py-1 px-1 md:p-2">
        <h1 className="text-md font-medium text-gray-800 dark:text-white">
          {data.name.length > 20 ? data.name.slice(0, 19) + "..." : data.name}
        </h1>
        ...
        <div className="flex justify-between mt-1 items-center">
          ...
          {isItemInCart ? (
            ...
            <button
              ...
              className="px-4 py-2 text-xs font-medium text-white uppercase transition-colors duration-300 transform bg-blue-800 rounded dark:bg-gray-700 hover:bg-gray-700 dark:hover:bg-gray-600 focus:outline-none focus:bg-gray-700 dark:focus:bg-gray-600"
            >
              Add to Cart
            </button>
          )}
