  ...
  return (
    <div className=" py-1 ">
      ...
      <div className="grid grid-cols-3 md:grid-cols-4 gap-1 p-2">
        ...
        <div className="rounded-lg flex flex-col items-center p-1 bg-[#6D17CB]" onClick={()=>navigate(`/products?subCategory=Jeans`)}>
        ...
        <div className="rounded-lg flex flex-col items-center p-1 bg-[#6D17CB]" onClick={()=>navigate('/products?subCategory=Women%27s%20Footwear%20%26%20Accessories')}>
        ...
        <div className=" p-1 rounded-lg flex flex-col items-center bg-[#6D17CB]" onClick={()=>navigate('/products?subCategory=Casual%20Shoes')}>
        ...
        <div className=" p-1 rounded-lg flex flex-col items-center bg-[#6D17CB]" onClick={()=>navigate(`/products?subCategory=Pillow%20&%20Matress`)}>
        ...
        <div className="rounded-lg flex flex-col items-center p-1 bg-[#6D17CB]" onClick={()=>navigate('/products/category/Home%20Appliances')}>
        ...
        <div className="rounded-lg flex flex-col items-center p-1 bg-[#6D17CB]" onClick={()=>navigate('/products?subCategory=Kitchen%20items')}>
