  ...
  return (
    <div className=" py-1 ">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-1 ">
        ...
        <div className="rounded-lg flex flex-col items-center p-1" onClick={()=>navigate(`/products?subCategory=Women%27s%20Fashion`)}>
        ...
        <div className="  rounded-lg flex flex-col items-center p-1" onClick={()=>navigate('/products?subCategory=Women%27s%20Footwear%20%26%20Accessories')}>
