...
const SellerCreate = () => {
  ...
  const getAddressFromCoordinates = async (latitude, longitude) => {
    const apiKey = 'de5f86a14ff04d29a2d139f8741da342'; // Replace with your OpenCage API key
    ...
    try {
      ...
      if (data.results.length > 0) {
        const { postcode,  state, country, county,state_district, road,  } = data.results[0].components;
  ...
  const handleLocationFetch = async () => {
    ...
    try {
      const { latitude, longitude } = await getSellerLocation();
      ...
      setError(error.message || 'Failed to retrieve location information');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    ...
    //         src={logo}
    //         alt="Jamalpur Bazaar"
    //         className="h-20 mx-auto bg-blue-600"
    //       />
    //       <h2 className="text-3xl font-bold text-gray-800 mt-4">
    //         Welcome to Jamalpur Bazaar!
    //       </h2>
    //       <p className="text-gray-600 mt-2">
    //         Join us today and start selling your products in our vibrant
    //         marketplace.
    //       </p>
    //     </div>
    ...
    //         src={backgroundImage}
    //         alt="Background"
    //         className="absolute inset-0 w-full h-full object-cover rounded-lg opacity-25"
    //       />
    ...
    //         "Jamalpur Bazaar has transformed our business. We've reached
    ...
    //               You'll need a valid email address, a phone number, and basic
    //               details about your shop (such as name and address).
    //             </div>
    //           </details>
    ...
    //             </summary>
    //             <div className="mt-2 text-gray-600">
    //               Setting up a shop is quick and easy. You can get started in
    //               just a few minutes.
    //             </div>
    //           </details>
    ...
    //             </summary>
    //             <div className="mt-2 text-gray-600">
    //               We offer 24/7 dedicated support to help you every step of the
    //               way.
    //             </div>
    //           </details>
    //         </div>
