...
const OrderReport = ({ sidebarOpen }) => {
  ...
  const ongoingProduct = orders?.filter(
    (order) => order?.status !== "Cancled" || "Delivered"
  );
        ...
        >
          ...
          <div className="w-full mt-2 bg-white p-3 rounded-md hover:shadow-md">
            <div className="p-2 rounded-md ">
              <h2 className="my-1 text-[20px] text-gray-600 font-medium">
                Filter Order{" "}
              </h2>
            ...
            <div className="mt-1 flex items-center justify-end">
              <button
                type="submit"
                className={`text-white w-[15vw] bg-blue-600 hover:bg-blue-800 font-semibold text-center border rounded-md py-1 px-5 flex items-center justify-center ${
                ...
                <div className="left-content-card p-4 bg-white rounded-lg shadow-md w-full ">
                  <div className="flex items-center justify-center gap-2 ">
                    ...
                    <div className="info mt-1 flex flex-col items-center justify-center p-2 ">
                      <h4 className="subtitle text-lg font-semibold">
                        {orders?.length}
                      </h4>
                  ...
                  <div className="coupon__discount w-full text-right flex justify-between gap-4 mt-4">
                    ...
                    <div className="text-center">
                      ...
                      <div className="mt-2 flex items-center justify-center space-x-2">
                        ...
                        <span
                          ...
                          data-tooltip="This count is the summation of Failed to deliver, Canceled, And Returned orders"
                        >
                          <img
                    ...
                    <div className="text-center">
                      <strong className="text-blue-500 text-lg">
                        {ongoingProduct?.length}
                      </strong>
                      <div className="mt-2 flex items-center justify-center space-x-2">
                        <span>Ongoing</span>
                        <span
                          className="tooltip ml-2"
                          data-tooltip="This count is the summation of Pending, Confirmed, Packaging, Out for delivery orders"
                        >
                          <img
                            className="info-img w-4 h-4"
                            src="https://6valley.6amtech.com/public/assets/back-end/img/info-circle.svg"
                    ...
                    <div className="text-center">
                      ...
                      <div className="mt-2 flex items-center justify-center space-x-2">
                        ...
                        <span
                          className="tooltip ml-2"
                          data-tooltip="This count is the summation of delivered orders"
                        >
                          <img
                            className="info-img w-4 h-4"
                            src="https://6valley.6amtech.com/public/assets/back-end/img/info-circle.svg"
                ...
                <div className="left-content-card p-4 bg-white rounded-lg shadow-md w-full">
                  <div className="flex items-center justify-center gap-2">
                    ...
                    <div className="info mt-1">
                      <h4 className="subtitle text-lg font-semibold">
                        ₹{seller?.availableBalance + seller?.totalWithdraw}
                      </h4>
                      <h6 className="subtext text-gray-500">
                        Total Order Amount
                      </h6>
                    </div>
                  </div>
                  ...
                  <div className="coupon__discount w-full text-right flex justify-between mt-4">
                    ...
                    <div className="text-center">
                      ...
                      <div className="mt-2 flex items-center justify-center space-x-2">
                        ...
                        <span
                          className="tooltip ml-2"
                          data-tooltip="The ongoing order amount will be shown here"
                        >
                          <img
                            className="w-4 h-4"
                            src="https://6valley.6amtech.com/public/assets/back-end/img/info-circle.svg"
                    ...
                    <div className="text-center">
                      ...
                      <div className="mt-2 flex items-center justify-center space-x-2">
                        ...
                        <span
                          className="tooltip ml-2"
                          data-tooltip="After the order is delivered total order amount will be shown here"
                        >
                          <img
                            className="w-4 h-4"
                            src="https://6valley.6amtech.com/public/assets/back-end/img/info-circle.svg"
          ...
          <div className="w-full mt-2 bg-white p-3 rounded-md  gap-2 hover:shadow-md">
            <div className="flex items-center justify-between  flex-col md:flex-row gap-2 md:gap-0">
              <div className="flex items-center    ">
                <div
                  className=" rounded-md px-3 py-1 flex items-center justify-center gap-1 cursor-pointer"
                  onClick={() => navigate("/dashboard-create-product")}
                >
                  <div className="">
                    Total Order :{" "}
                    <span className="px-2  rounded-md bg-slate-200">
                      {orders?.length}
                    </span>
                  </div>
                </div>
                                      ...
                                      className={`text-gray-700 text-center dark:text-gray-200 rounded-md 
                                                                            ${
                                                                              ...
                                                                              order?.status ===
                                                                                ...
                                                                                : "border border-green-500 px-2 bg-green-100 font-semibold rounded-md text-green-500"
                                                                            }`}
                                    >
                                      {order?.status}
                                    </span>
