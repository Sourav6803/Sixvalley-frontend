...
const PendingOrderTable = ({ pendingOrder, isLoading }) => {
  ...
  // const handleApplyDispatchDate = (start, end) => {
  //   setDispatchDates({ start, end });
  //   fetchFilteredOrders({ dispatchStartDate: start, dispatchEndDate: end });
  // };

  // const handleApplyOrderDate = (start, end) => {
  //   setOrderDates({ start, end });
  //   fetchFilteredOrders({ orderStartDate: start, orderEndDate: end });
  // };
