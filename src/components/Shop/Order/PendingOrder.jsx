...
const PendingOrder = () => {
  ...
  const currentData = (searchData || pendingOrder)?.slice(
    indexOfFirstItem,
    indexOfLastItem
  );
  ...
  const totalPages = Math.ceil(
    (searchData || pendingOrder)?.length / itemsPerPage
  );
      ...
      {isLoading ? (
        ...
        <div className="w-full p-2 md:p-5 bg-gray-200">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-[18px] text-slate-600 font-Poppins font-semibold">
              Pending Order List: {pendingOrder?.length}
            </h3>
          </div>

          <div className="w-full mt-2 bg-white p-3 rounded-md hover:shadow-md">
            <div className="p-4 rounded-md ">
              <h2 className="my-3 text-[18px] text-gray-600 font-medium">
                Filter Order{" "}
              </h2>
          ...
          <div className="w-full mt-2 bg-white p-3 rounded-md  gap-2 hover:shadow-md">
            <div className="flex items-center justify-between  flex-col md:flex-row gap-2 md:gap-0">
              <div className="flex items-center text-white   ">
                <div
                  className="bg-blue-700 rounded-md px-3 py-1 flex items-center justify-center gap-1 cursor-pointer"
                              ...
                              currentData?.map((order, index) => (
                                <tr key={index}>
                                  ...
                                  <td className="px-4  py-2 w-[50px]  ">
                                    <div className="w-full gap-x-1 flex flex-col text-[12px]">
                                  ...
                                  <td className="px-4 py-4 text-sm whitespace-nowrap">
                                    <div className="flex items-center justify-end">
                                      <div className="w-full mt-4 flex items-center justify-center gap-2 bg-white  ">
                                        <button className="text-xl border-2 rounded-md p-1 border-blue-700 hover:bg-blue-600 hover:text-white transition-colors duration-200">
                                          <AiOutlineEye
