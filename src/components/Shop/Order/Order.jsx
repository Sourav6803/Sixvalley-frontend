...
const Order = ({open}) => {
  ...
  const tabs = [
    ...
    { id: 3, name: "Shipped", count: shippedOrder?.length },
    { id: 4, name: "Cancelled", count: cancledOrder?.length },
  ];
            ...
            <div className="mt-3">
              ...
              <div className="mt-4">
                ...
                {currentTable === "confirmed" && (
                  <ReadyToShipOrderTable confirmedOrder={confirmedOrder} isLoading={isLoading} />
                )}
