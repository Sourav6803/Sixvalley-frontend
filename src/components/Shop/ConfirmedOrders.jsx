...
const ConfirmedOrders = () => {
    ...
    const currentData = (searchData || confirmedOrder)?.slice(indexOfFirstItem, indexOfLastItem);

    // Calculate total pages
    const totalPages = Math.ceil((searchData || confirmedOrder)?.length / itemsPerPage);
                            ...
                            <section className="container px-4 mt-2 ">
                                ...
                                <div className="flex flex-col mt-6">
                                    ...
                                    ${(order?.status === "Returned" ||
                                                            ...
                                                            <tr>
                                                                <td colSpan="5" className="text-center py-4 text-gray-500 dark:text-gray-400">No Confirmed order found</td>
                                                            </tr>
                                                        )}
                                                    </tbody>
                                                </table>
