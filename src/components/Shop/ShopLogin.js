...
import { BarChart3, Headphones, CreditCard, Megaphone, Package, Users } from "lucide-react";
          ...
          <>
            ...
            <div className="relative">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center bg-black bg-opacity-50">
                <h1 className="text-white text-4xl font-bold sm:text-5xl ml-2">
                  Welcome Back, Seller!
                </h1>
            ...
            <div className="mt-12 text-center text-gray-700 sm:mx-auto sm:w-full sm:max-w-lg p-2">
              <h3 className="text-2xl font-semibold">Why Sell with Us?</h3>
              <p className="mt-4 text-sm">
                Join thousands of successful sellers who trust our platform to
                reach millions of customers every day. With tools designed to
                make selling easy, your business is in good hands.
              </p>

              <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="p-4 bg-white shadow-md rounded-lg flex items-center space-x-3">
                  <BarChart3 className="text-blue-600 w-6 h-6" />
                  <div>
                    <h4 className="font-medium text-lg">Track Your Sales</h4>
                    <p className="text-sm mt-1 text-gray-600">
                      Get real-time analytics and insights on your sales
                      performance.
                    </p>
                  </div>
                </div>
                ...
                <div className="p-4 bg-white shadow-md rounded-lg flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm mt-1 text-gray-600">
                      Receive payments quickly with secure and reliable
                      transactions.
                    </p>
                  </div>
                </div>
                <div className="p-4 bg-white shadow-md rounded-lg flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm mt-1 text-gray-600">
                      Leverage our platform’s marketing campaigns to boost
                      sales.
                    </p>
                  </div>
                </div>
                <div className="p-4 bg-white shadow-md rounded-lg flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm mt-1 text-gray-600">
                      Add and manage products effortlessly with a user-friendly
                      dashboard.
                    </p>
                  </div>
                </div>
                <div className="p-4 bg-white shadow-md rounded-lg flex items-center space-x-3">
                  ...
                  <div>
                    <h4 className="font-medium text-lg">Wide Customer Reach</h4>
                    <p className="text-sm mt-1 text-gray-600">
                      Expand your business by reaching a vast and diverse
                      customer base.
                    </p>
                  </div>
                </div>
