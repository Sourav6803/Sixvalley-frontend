      ...
      <ul className="pt-2">
        {
          menusToDisplay.map((menu, index) => (
            <React.Fragment key={index}>
              <li key={index} className={`text-gray-300 text-sm flex items-center gap-x-4  cursor-pointer p-2 hover:bg-[#657082] rounded-md ${menu?.spacing ? "mt-3" : "mt-2"}`} onClick={() => toggleMenu(index)}>
