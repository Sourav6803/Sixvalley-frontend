...
const AllProducts = ({ opens }) => {
    ...
    async (id) => {
      try {
        ...
        const res = await axios.delete(
          `${server}/subSubCategory/delete-subSubCategory/${id}`,
  ...
  const currentData = (searchData || products)?.slice(
    indexOfFirstItem,
    indexOfLastItem
  );
                        ...
                        <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                          <thead className="bg-gray-50 ">
                            <tr>
                              ...
                              <th
                                scope="col"
                                className="px-4 py-3.5 text-sm font-normal text-center text-gray-500  whitespace-nowrap"
                              >
                                Verify Status
                              </th>
