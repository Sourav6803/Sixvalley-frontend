...
import securePayments from "./images/secure-payment.png" 
import freeShipping from "./images/3d-truck.png"
import dailySurrizeOffer from "./images/discount-tag.png"
import affortablePrice from "./images/money-saving.png"
...
export const brandingData = [
  {
    ...
    icon: (
      <img src={freeShipping} alt="Free shipping" height={50} width={50} />
    ),
  },
  {
    id: 2,
    ...
    icon: (
      <img src={dailySurrizeOffer} alt="Daily" height={50} width={50} />
    ),
  },
  {
    id: 4,
    ...
    icon: (
      <img src={affortablePrice} alt="Free shipping" height={50} width={50} />
    ),
  },
  {
    id: 5,
    ...
    icon: (
      <img src={securePayments} alt="sec" height={50} width={50} />
    ),
  },
];
...
export const catalogOptions = [
  {
    id: "orders",
    title: "Catalogs to Increase Orders",
    image: "https://img.icons8.com/ios/50/rocket--v1.png",
    description:
      "Recommended based on views, clicks, orders, returns & ROI of your catalogs",
    isAvailable: true,
    button: "Select Catalogs",
    recomended: true,
  },
  {
    id: "views",
    title: "New Catalogs to Increase Views",
    image: "https://img.icons8.com/dotty/80/commercial.png",
    description:
      "Catalogs uploaded in the last 30 days with less views are recommended",
    isAvailable: false,
    recomended: false,
  },
  {
    id: "manual",
    title: "Manually Select Catalogs",
    image: "https://img.icons8.com/ios/50/todo-list--v1.png",
    description: "Select any of your live catalogs",
    isAvailable: true,
    button: "Select Catalogs",
    recomended: false,
  },
...
export const districtData  = {
  AndhraPradesh: ["Anantapuramu", "Nandyal", "East Godavari", /* …more… */ "West Godavari"],
  ArunachalPradesh: ["Anjaw", "Changlang", "East Kameng", /* … */ "Tawang"],
  Assam: ["Baksa", "Barpeta", "Biswanath", /* … */ "Udalguri"],
  "Bihar": ["Araria", "Arwal", "Aurangabad", /* … */ "West Champaran"],
  "Chhattisgarh": ["Bastar", "Bilaspur", "Dantewada", /* … */ "Sukma"],
  "Goa": ["North Goa", "South Goa"],
  "Gujarat": ["Ahmedabad", "Amreli", "Anand", /* … */ "Valsad"],
  "Haryana": ["Ambala", "Bhiwani", "Charkhi Dadri", /* … */ "Yamunanagar"],
  "Himachal Pradesh": ["Bilaspur", "Chamba", "Hamirpur", /* … */ "Sirmaur"],
  "Jharkhand": ["Bokaro", "Chatra", "Deoghar", /* … */ "West Singhbhum"],
  "Karnataka": ["Bagalkot", "Bangalore Rural", "Bangalore Urban", /* … */ "Yadgir"],
  "Kerala": ["Alappuzha", "Ernakulam", "Idukki", /* … */ "Wayanad"],
  "Madhya Pradesh": ["Agar Malwa", "Alirajpur", "Anuppur", /* … */ "Vidisha"],
  "Maharashtra": ["Ahmednagar", "Akola", "Amravati", /* … */ "Yavatmal"],
  "Manipur": ["Bishnupur", "Chandel", "Churachandpur", /* … */ "Thoubal"],
  "Meghalaya": ["East Garo Hills", "East Jaintia Hills", "East Khasi Hills", /* … */ "West Jaintia Hills"],
  "Mizoram": ["Aizawl", "Champhai", "Hnahthial", /* … */ "Zunheboto"],
  "Nagaland": ["Dimapur", "Kiphire", "Kohima", /* … */ "Zunheboto"],
  "Odisha": ["Angul", "Balangir", "Balasore", /* … */ "Yamunanagar"],
  "Punjab": ["Amritsar", "Barnala", "Bathinda", /* … */ "Pathankot"],
  "Rajasthan": ["Ajmer", "Alwar", "Banswara", /* … */ "Yunusabad"],
  "Sikkim": ["East Sikkim", "North Sikkim", "South Sikkim", "West Sikkim"],
  "Tamil Nadu": ["Ariyalur", "Chengalpattu", "Chennai", /* … */ "Virudhunagar"],
  "Telangana": ["Adilabad", "Bhadradri Kothagudem", "Hyderabad", /* … */ "Wanaparthy"],
  "Tripura": ["Dhalai", "Gomati", "Khowai", "Sepahijala", "Unakoti", "West Tripura"],
  "Uttar Pradesh": ["Agra", "Aligarh", "Ambedkar Nagar", /* … */ "Zafarabad"],
  "Uttarakhand": ["Almora", "Bageshwar", "Chamoli", /* … */ "Udham Singh Nagar"],
  "West Bengal": ["Alipurduar", "Bankura", "Birbhum", "Cooch Behar", "Dakshin Dinajpur", "Darjeeling", "Hooghly", "Howrah", "Jalpaiguri", "Jhargram", "Kalimpong", "Kolkata", "Malda", "Murshidabad", "Nadia", "North 24 Parganas", "Paschim Bardhaman", "Paschim Medinipur", "Purba Bardhaman", "Purba Medinipur", "Purulia", "South 24 Parganas", "Uttar Dinajpur"],
  // Includes union territories similarly, e.g. "Delhi": ["Central Delhi", "East Delhi", …]
}
